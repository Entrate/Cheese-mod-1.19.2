...
public enum ModArmourMaterials implements ArmorMaterial {
    ...
    NETHERITE_LEGENDARY_CHEESE("netherite_legendary_cheese", 74, new int[]{6, 12, 16, 6}, 0, SoundEvents.ARMOR_EQUIP_NETHERITE, 6.0F, 0.1F, () -> {
        return Ingredient.of(ModItems.NETHERITE_LEGENDARY_CHEESE.get());
    });
    ...
    public String getName() {
        return CheeseMod.MOD_ID + ":" + this.name;
    }
