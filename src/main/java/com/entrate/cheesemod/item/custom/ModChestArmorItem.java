...
public class ModChestArmorItem extends ArmorItem {
    ...
    public ModChestArmorItem(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
    ...
    private void evaluateArmorEffects(Player player) {
        for (Map.Entry<ArmorMaterial, MobEffectInstance> entry : MATERIAL_TO_EFFECT_MAP.entrySet()) {
            ...
            if(hasCorrectChestOn(mapArmorMaterial, player)) {
    ...
    private void addStatusEffectForMaterial(Player player, ArmorMaterial mapArmorMaterial,
        ...
        if(hasCorrectChestOn(mapArmorMaterial, player) && !hasPlayerEffect) {
